...
class Server {
    ...
    static loadConfig() {
        ...
        if (config.mdns && config.mdns.legacyAdvertiser === false && config.bridge.advertiser === "bonjour-hap" /* MDNSAdvertiser.BONJOUR */) {
            log.error(`The "mdns"."legacyAdvertiser" = false option has been removed. Please use "bridge"."advertiser" = "${"ciao" /* MDNSAdvertiser.CIAO */}" to enable the Ciao mDNS advertiser. You should remove the "mdns"."legacyAdvertiser" section from your config.json.`);
        }
        return config;
    }
    loadAccessories() {
        ...
        this.config.accessories.forEach((accessoryConfig, index) => {
            ...
            if (accessoryConfig._bridge) {
                ...
                if (this.childBridges.has(accessoryConfig._bridge.username)) {
                    ...
                    childBridge = new childBridgeService_1.ChildBridgeService("accessory" /* PluginType.ACCESSORY */, accessoryIdentifier, plugin, accessoryConfig._bridge, this.config, this.options, this.api, this.ipcService, this.externalPortService);
    ...
    loadPlatforms() {
        ...
        this.config.platforms.forEach((platformConfig, index) => {
            ...
            if (platformConfig._bridge) {
                ...
                const childBridge = new childBridgeService_1.ChildBridgeService("platform" /* PluginType.PLATFORM */, platformIdentifier, plugin, platformConfig._bridge, this.config, this.options, this.api, this.ipcService, this.externalPortService);
